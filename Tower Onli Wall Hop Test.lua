...
local playerHighlightColor = Color3.new(1, 0, 0) -- Cor inicial do contorno e preenchimento dos jogadores (vermelho)
...
local function ativarESPPlayer()
    ...
    -- Aplica a cor selecionada no dropdown imediatamente
    local currentColor = redzlib.Flags["PlayerEspColor"] or "Red"
...
local function ativarESPEspada()
    ...
    -- Aplica a cor selecionada no dropdown imediatamente
    local currentColor = redzlib.Flags["SwordEspColor"] or "Red"
